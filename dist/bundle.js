...
const keypress$ = rxjs_1.Observable.fromEvent(input, 'keyup')
...
//  (value)=>console.log(value);
(value) => {
    if ((value.length === combo.length) && (value.every((element, index) => element === combo[index]))) {
        alert('Bravo');
    }
    else {
        console.log('Fail');
...
//# sourceMappingURL=data:application/json;base64,
